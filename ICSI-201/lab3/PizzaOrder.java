...
public class PizzaOrder
{
   public static void main (String[] args)
   {
      ...
      // ADD LINES HERE FOR TASK #1
       ...
       // condition compares strings for user discount 
      ...
      // condtional statemts for cost of pizza via size of pizza in inches 
      if( inches == 10)
          cost = 10.99;
      else if ( inches == 12)
          cost = 12.99;
          ...
          System.out.println("That was not one of the choices so a " + 
                              "12 inch Pizza will be made. ");
      ...
      //switch statement for crust types..lowercase and uppercase covered
      switch ( crustType ) {
        case 'H':
          crust = "Hand-tossed";
          break;
      ...
      if(discount == true)
      {
        System.out.print("You are eligible for a $2.00 discount\n");
        cost = (cost - 2.00);
      }
