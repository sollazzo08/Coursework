...
public class DiceSimulation_For
{
   public static void main(String[] args)
   {
      ...
      for(count= 0; count < NUMBER; count++) // for loop that simulates rolling dice 10000 times 
      {
        die1Value = generator.nextInt(7); // random number generated and assigned for var. die1
        die2Value = generator.nextInt(7); // random number generated and assigned for var. die2
