...
public class DiceSimulation
{
   public static void main(String[] args)
   {
      ...
      // while loops simulates rolling dice 10000 times 
     while(count < NUMBER)
     {
       count++; //increments count by 1 
      
      die1Value = generator.nextInt(7); // var die1 gets random # generated and assigned between 0 and 6 
      die2Value = generator.nextInt(7); // var die2 gets random # generated and assigned between 0 and 6 
